...
# .vaked file, not here.
{
  description = "v0p5-demo — generated by Vaked";
  ...
  inputs = {
    ...
    # index testCorpus — sources (unpinned; flake.lock records the resolved rev).
    # 0012 §4.2: each index source becomes a flake input.
    testCorpus-src-example-repo = { url = "github:example/example-repo"; flake = false; };
  };

  outputs = { self, nixpkgs, ... }@inputs:
    let
      # runtime v0p5-demo — systems = ["x86_64-linux"]
    ...
    in
    {
      ...
      nixosModules.v0p5-demo = import ./nixos/v0p5-demo.nix {
