...
| `memoryd` | Zig | — | Runtime memory plane for the `memory` kind: mines `source` streams into typed entries appended via `eventd`, serves capability-bound recall over the folded state ([0014](../language/0014-memory-primitive.md), [design](../superpowers/specs/2026-06-13-memoryd-design.md), #24) |
