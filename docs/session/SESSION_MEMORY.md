...
## Architecture
Layer Collapse (5→1) · mmap MemoryPlane · QuickJS C-FFI · 256 subagent slots · 10x10 Matrix Council · Synapsed P2P · Ouroboros
...
## All Reports
benchmarks · session-audit · compression-proof · memory-lane · self-reflection-10rounds · vakedc-ultracompression

## Blog Posts
part1-migration · part2-swarm · review-openrouterd · 415ms-tests

## The Stack
Zig 0.16 · io_uring · mmap · seccomp(22) · QuickJS · TypeScript · Go · Python · Rust
