...
- Initiates `HELLO` control frame at connection start with supported schema digests and heartbeat parameters (RFC 0003 §5.5.1),
- Tracks chapter state (OPEN / PAUSED / REWINDING / CLOSED)
- Sends `BYE` control frame at graceful shutdown (RFC 0003 §5.7)
