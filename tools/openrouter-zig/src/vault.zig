//! OpenBao/Vault client — secrets never touch disk.
//! 1:1 with @vaked/openrouter-ts/src/bao.ts
...
/// Vault client — resolves secrets with env fallback.
pub const Vault = struct {
    ...
    /// GET /v1/secret/data/:path — returns key-value data
    ...
    /// Resolve secret: Vault first, env fallback.
    ...
    /// Generic HTTP GET with Vault auth.
