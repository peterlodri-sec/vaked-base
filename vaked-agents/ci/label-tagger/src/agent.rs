...
pub(crate) struct TaggerRunner {
    pub(crate) runner: Runner,
    pub(crate) sessions: Arc<dyn SessionService>,
}

pub(crate) fn build_runner(cfg: &Config, api_key: &str) -> Result<TaggerRunner> {
...
pub(crate) async fn ask(rr: &TaggerRunner, prompt: String) -> Result<String> {
