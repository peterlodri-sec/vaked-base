...
pub(crate) fn system_prompt(max_findings: u32, crabcc_budget: u32, structured: bool) -> String {
...
pub(crate) fn docs_review_prompt(max_findings: u32, crabcc_budget: u32, structured: bool) -> String {
