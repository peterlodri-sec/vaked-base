...
|-------|------|---------|----------|-------|------|
| **blogger** | Shell | push to main (blog/ changes), dispatch | `tools/blogger/` | — | Publishes blog posts to vaked.dev |
| **optimizer** | Shell | PR opened/synchronize, dispatch | `tools/optimizer/` | — | Ultra-compresses all layers (5-10 rounds). Dogfeeds bidirectionally — pushes optimized code back to PR. |
