...
// SockFprog was removed from the Zig 0.16 stdlib; define it manually.
// Matches the kernel's struct sock_fprog layout.
...
pub fn apply() void {
    ...
    // Zig 0.16: linux.seccomp() third arg is now ?*const anyopaque
    _ = linux.seccomp(linux.SECCOMP.SET_MODE_FILTER, linux.SECCOMP.FILTER_FLAG.TSYNC, @ptrCast(&prog));
